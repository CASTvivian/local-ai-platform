# Missing Repo Summary Source: T-Lab-CUHKSZ/claude-code

- URL: https://github.com/T-Lab-CUHKSZ/claude-code
- Local Path: core-platform/data/brain_assets/repos/github_stars_missing/T-Lab-CUHKSZ__claude-code
- Clone Status: cloned
- Language: TypeScript
- Stars: 309
- Topics: 
- Description: Claude Code Source - Buildable Research Fork. Reverse-engineered build system, runnable with Bun.
