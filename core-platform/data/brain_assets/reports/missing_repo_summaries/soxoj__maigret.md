# Missing Repo Summary Source: soxoj/maigret

- URL: https://github.com/soxoj/maigret
- Local Path: core-platform/data/brain_assets/repos/github_stars_missing/soxoj__maigret
- Clone Status: cloned
- Language: Python
- Stars: 28133
...
`--ai` collects the search results, builds an internal Markdown repo
...
- [SOTL-6.2. Check Nicknames Reuse To Find Another Account](https://sowel.soxoj.c
