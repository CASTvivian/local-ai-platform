# Missing Repo Summary Source: oboard/claude-code-rev

- URL: https://github.com/oboard/claude-code-rev
- Local Path: core-platform/data/brain_assets/repos/github_stars_missing/oboard__claude-code-rev
- Clone Status: cloned
- Language: TypeScript
- Stars: 3123
- Topics: claude-code
- Description: Runnable ClaudeCode source code
