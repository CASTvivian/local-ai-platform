# Missing Repo Summary Source: eliben/raft

- URL: https://github.com/eliben/raft
- Local Path: core-platform/data/brain_assets/repos/github_stars_missing/eliben__raft
- Clone Status: cloned
- Language: Go
- Stars: 1375
- Topics: 
- Description: :rowboat: Raft implementation in Go
