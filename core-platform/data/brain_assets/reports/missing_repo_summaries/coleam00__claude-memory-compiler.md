# Missing Repo Summary Source: coleam00/claude-memory-compiler

- URL: https://github.com/coleam00/claude-memory-compiler
- Local Path: core-platform/data/brain_assets/repos/github_stars_missing/coleam00__claude-memory-compiler
- Clone Status: cloned
- Language: Python
- Stars: 1040
- Topics: 
