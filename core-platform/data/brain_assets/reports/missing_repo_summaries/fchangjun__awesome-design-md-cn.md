# Missing Repo Summary Source: fchangjun/awesome-design-md-cn

- URL: https://github.com/fchangjun/awesome-design-md-cn
- Local Path: core-platform/data/brain_assets/repos/github_stars_missing/fchangjun__awesome-design-md-cn
- Clone Status: cloned
- Language: HTML
- Stars: 84
- Topics: 
- Description: Stitch 提出的设计系统文档格式 —— 用纯文本 Markdown 记录设计系统，让 AI 编码 Agent 能够生成风格一致的 UI。
...
- [**Tesla**](https://github.com/fchangjun/awesome-design-md-cn/tree/main/design
