# Missing Repo Summary Source: liangdabiao/Godogen

- URL: https://github.com/liangdabiao/Godogen
- Local Path: core-platform/data/brain_assets/repos/github_stars_missing/liangdabiao__Godogen
- Clone Status: cloned
- Language: Python
- Stars: 47
- Topics: 
- Description: liang's Godogen: 使用 Claude Code 构建完整 Godot 4 项目的技能集,你描述你想要的内容。AI pipeline 会设计架构、生成美术资源、编写每一行代码、从运行的游戏引擎中截取截图，并修复看起来不对的地方。输出是一个真正的 Godot 4 项目，包含组织良好的场景、可读的脚本和正确的游戏架构。继承二开：github.com/htdt/godogen 
