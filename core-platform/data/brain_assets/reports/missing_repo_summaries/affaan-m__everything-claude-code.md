# Missing Repo Summary Source: affaan-m/everything-claude-code

- URL: https://github.com/affaan-m/everything-claude-code
- Local Path: core-platform/data/brain_assets/repos/github_stars_missing/affaan-m__everything-claude-code
- Clone Status: cloned
- Language: JavaScript
- Stars: 180549
...
- **5 new generic business/content skills** — `article-writing`, 
...
**Issue:** Hooks should keep a consistent Node-mode dispatch surface. Continuous-learning observation now dispatches through `run-with-flags.js` and `observe-r

# FILE: docs/PLAN-PRD-PATTERN.md
...
- `/code-review` — reviews local diffs or PRs; auto-detects `.claude/

# FILE: examples/hud-status-contract.json
...
# FILE: examples/harmonyos-app-CLAUDE.md
...
class InsufficientStockError(APIEx
