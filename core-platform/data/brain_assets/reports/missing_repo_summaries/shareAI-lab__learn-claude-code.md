# Missing Repo Summary Source: shareAI-lab/learn-claude-code

- URL: https://github.com/shareAI-lab/learn-claude-code
- Local Path: core-platform/data/brain_assets/repos/github_stars_missing/shareAI-lab__learn-claude-code
- Clone Status: cloned
- Language: TypeScript
- Stars: 60059
...
# FILE: docs/ja/s08-background-tasks.md
...
# FILE: docs/ja/s01-the-agent-loop.md
