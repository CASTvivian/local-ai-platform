# Missing Repo Summary Source: browser-use/browser-harness

- URL: https://github.com/browser-use/browser-harness
- Local Path: core-platform/data/brain_assets/repos/github_stars_missing/browser-use__browser-harness
- Clone Status: cloned
- Language: Python
- Stars: 12323
- Topics: 
