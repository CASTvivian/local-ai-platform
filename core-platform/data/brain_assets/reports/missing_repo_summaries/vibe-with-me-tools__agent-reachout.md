# Missing Repo Summary Source: vibe-with-me-tools/agent-reachout

- URL: https://github.com/vibe-with-me-tools/agent-reachout
- Local Path: core-platform/data/brain_assets/repos/github_stars_missing/vibe-with-me-tools__agent-reachout
- Clone Status: cloned
- Language: TypeScript
- Stars: 42
- Topics: agentic-ai, claude-code, claude-code-plugin, llm, mcp, messaging, notifications, productivity, telegram, vibe-coding
