# Missing Repo Summary Source: perkfly/ex-skill

- URL: https://github.com/perkfly/ex-skill
- Local Path: core-platform/data/brain_assets/repos/github_stars_missing/perkfly__ex-skill
- Clone Status: cloned
- Language: Python
- Stars: 1568
- Topics: 
- Description: 前任 skill
