# Repo Summary Source: bytedance/deer-flow
- URL: https://github.com/bytedance/deer-flow
- Local Path: core-platform/data/brain_assets/repos/github_stars/bytedance__deer-flow
...
**本番環境**（ローカルでイメージをビルドし、ランタイム設定とデータをマウ
...
2. **Run the setup wizard**
   ...
   > **Advanced / manual configuration**: If you
