# Repo Summary Source: rowboatlabs/rowboat
- URL: https://github.com/rowboatlabs/rowboat
- Local Path: core-platform/data/brain_assets/repos/github_stars/rowboatlabs__rowboat
...
That means you can plug in (for example) se
