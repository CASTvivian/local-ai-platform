# Repo Summary Source: HBAI-Ltd/Toonflow-app
- URL: https://github.com/HBAI-Ltd/Toonflow-app
- Local Path: core-platform/data/brain_assets/repos/github_stars/HBAI-Ltd__Toonflow-app
- Buckets: mcp, llm_runtime, ui, video
- Stars: 7875
- Language: HTML
...
- ✅ **Трёхуровневая система Agent-взаимодействия**  
  Совместная работа уровня принятия решений, уровня испо


# FILE: docs/README.th.md
...
- ✅ **ระบบผู้ให้บริการที่ตั้งโปรแกรมได้**  
  รองรับการเขียนตรรกะ TypeScript ของผู้ให้บริการในศูนย์การตั้งค่าและ生效 (มีผล) ทันที โดยไม่ต้องแก้ไขซอ
