# Repo Summary Source: heygen-com/hyperframes
- URL: https://github.com/heygen-com/hyperframes
- Local Path: core-platform/data/brain_assets/repos/github_stars/heygen-com__hyperframes
- Buckets: agent, mcp, video
- Stars: 17624
- Language: TypeScript
...
Hyperframes is inspired by [Remotion](https://www.remotion.dev) — we used Remotion at HeyGen in production, learned a ton from it, and kept attribution comments in the source for the patterns it pioneered (Chrome launch flags, image2pipe → FFmpeg streaming, frame buf
