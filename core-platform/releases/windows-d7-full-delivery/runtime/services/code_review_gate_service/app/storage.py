"""Storage layer for code review gate service with atomic writes and locking."""
...
from .models import StoreFile, ReviewResult
...
DATA_DIR = BASE_DIR / "data" / "code_review_gate"
...
def make_review_id() -> str:
    ...
    content = f"review:{datetime.utcnow().timestamp()}:{uuid.uuid4().hex}"
