"""Storage layer for workflow store service with atomic writes and locking."""
...
from .models import StoreFile, WorkflowRecord
...
def make_workflow_id(name: str, version: str) -> str:
