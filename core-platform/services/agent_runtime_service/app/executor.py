...
from .builtin.browser_operator import execute_browser_operator
from .builtin.memory_rag_core import execute_memory_rag_core
...
def register_default_executor_tools() -> None:
    ...
    register_tool("builtin.memory_rag_core.execute", _handler_builtin_memory_rag_core_execute)
    register_tool("builtin.browser_operator.execute", _handler_builtin_browser_operator_execute)
